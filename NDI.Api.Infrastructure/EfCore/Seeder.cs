...
public static class Seeder
{
    public static void SeedAsync(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MemoryCard>().HasData(
            new MemoryCard
            {
                Title = "Le réchauffement climatique",
                Informations = new List<Information>(){ informations[0] },
            },
            new MemoryCard
            {
                Title = "La pollution",
                Informations = new List<Information>(){ informations[1] },
            },
            new MemoryCard
            {
                Title = "La fonte des glaces",
                Informations = new List<Information>(){ informations[2] },
            },
            new MemoryCard()
            {
                Title = "Transports : transformer les mobilités individuelles",
                Informations = new List<Information>(){informations[3] },
            },
            new MemoryCard()
            {
                Title = "Agriculture et alimentation : moins de viande, plus de pratiques durables",
                Informations = new List<Information>(){informations[4] },
            }
        );
    }
}